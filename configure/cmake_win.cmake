...
if(CMAKE_CL_64)
link_directories(${PTHREAD_WIN}/Pre-built.2/lib/x64/)
else(CMAKE_CL_64)
link_directories(${PTHREAD_WIN}/Pre-built.2/lib/x86/)
endif(CMAKE_CL_64)
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
...
install(DIRECTORY ${OMNI_BASE}/include/omnithread DESTINATION include COMPONENT headers PATTERN "*.h" PATTERN "*.in" EXCLUDE)
...
install(FILES ${ZMQ_BASE}/include/zmq.hpp DESTINATION include COMPONENT headers)
install(FILES ${ZMQ_BASE}/include/zmq_addon.hpp DESTINATION include COMPONENT headers)
...
install(FILES ${OMNI_BASE}/lib/x86_win32/omniORB4_rtd.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omniDynamic4_rtd.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omnithread_rtd.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/COS4_rtd.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omniORB421_rtd.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omniDynamic421_rtd.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omnithread40_rtd.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/COS421_rtd.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/msvcstubd.lib DESTINATION bin COMPONENT dynamic)
...
install(FILES ${OMNI_BASE}/lib/x86_win32/omniORB4_rt.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omniDynamic4_rt.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omnithread_rt.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/COS4_rt.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omniORB421_rt.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omniDynamic421_rt.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/omnithread40_rt.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/COS421_rt.lib DESTINATION bin COMPONENT dynamic)
install(FILES ${OMNI_BASE}/lib/x86_win32/msvcstub.lib DESTINATION bin COMPONENT dynamic)
...
install(FILES ${ZMQ_BASE}/lib/Debug/libzmq-v90-mt-gd-4_1_7.lib DESTINATION lib COMPONENT static)
install(FILES ${ZMQ_BASE}/bin/Debug/libzmq-v90-mt-gd-4_1_7.dll DESTINATION bin COMPONENT dynamic)
else(CMAKE_BUILD_TYPE STREQUAL "Debug")
...
install(FILES ${ZMQ_BASE}/lib/Release/libzmq-v90-mt-4_1_7.lib DESTINATION lib COMPONENT static)
install(FILES ${ZMQ_BASE}/bin/Release/libzmq-v90-mt-4_1_7.dll DESTINATION bin COMPONENT dynamic)
endif(CMAKE_BUILD_TYPE STREQUAL "Debug")
endif(MSVC90)
...
install(FILES ${ZMQ_BASE}/lib/Debug/libzmq-v100-mt-gd-4_1_7.lib DESTINATION lib COMPONENT static)
install(FILES ${ZMQ_BASE}/bin/Debug/libzmq-v100-mt-gd-4_1_7.dll DESTINATION bin COMPONENT dynamic)
else(CMAKE_BUILD_TYPE STREQUAL "Debug")
...
install(FILES ${ZMQ_BASE}/lib/Release/libzmq-v100-mt-4_1_7.lib DESTINATION lib COMPONENT static)
install(FILES ${ZMQ_BASE}/bin/Release/libzmq-v100-mt-4_1_7.dll DESTINATION bin COMPONENT dynamic)
endif(CMAKE_BUILD_TYPE STREQUAL "Debug")
endif(MSVC10)
...
install(FILES ${ZMQ_BASE}/lib/Debug/libzmq-v120-mt-gd-4_1_7.lib DESTINATION lib COMPONENT static)
install(FILES ${ZMQ_BASE}/bin/Debug/libzmq-v120-mt-gd-4_1_7.dll DESTINATION bin COMPONENT dynamic)
else(CMAKE_BUILD_TYPE STREQUAL "Debug")
...
install(FILES ${ZMQ_BASE}/lib/Release/libzmq-v120-mt-4_1_7.lib DESTINATION lib COMPONENT static)
install(FILES ${ZMQ_BASE}/bin/Release/libzmq-v120-mt-4_1_7.dll DESTINATION bin COMPONENT dynamic)
endif(CMAKE_BUILD_TYPE STREQUAL "Debug")
endif(MSVC12)
...
install(FILES ${ZMQ_BASE}/lib/Debug/libzmq-v140-mt-gd-4_1_7.lib DESTINATION lib COMPONENT static)
install(FILES ${ZMQ_BASE}/bin/Debug/libzmq-v140-mt-gd-4_1_7.dll DESTINATION bin COMPONENT dynamic)
else(CMAKE_BUILD_TYPE STREQUAL "Debug")
...
install(FILES ${ZMQ_BASE}/lib/Release/libzmq-v140-mt-4_1_7.lib DESTINATION lib COMPONENT static)
install(FILES ${ZMQ_BASE}/bin/Release/libzmq-v140-mt-4_1_7.dll DESTINATION bin COMPONENT dynamic)
endif(CMAKE_BUILD_TYPE STREQUAL "Debug")
endif(MSVC14)
#pthreads
if(CMAKE_CL_64)
install(FILES ${PTHREAD_WIN}/Pre-built.2/lib/x64/pthreadVC2.lib DESTINATION lib COMPONENT static)
install(FILES ${PTHREAD_WIN}/Pre-built.2/dll/x64/pthreadVC2.dll DESTINATION bin COMPONENT dynamic)
else(CMAKE_CL_64)
install(FILES ${PTHREAD_WIN}/Pre-built.2/lib/x86/pthreadVC2.lib DESTINATION lib COMPONENT static)
install(FILES ${PTHREAD_WIN}/Pre-built.2/dll/x86/pthreadVC2.dll DESTINATION bin COMPONENT dynamic)
endif(CMAKE_CL_64)
